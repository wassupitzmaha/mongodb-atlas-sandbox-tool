...
async function testIntegration() {
    try {
        ...
        console.log('3️⃣ Testing Production Cluster Access...');
        ...
        console.log('4️⃣ Testing Snapshot Availability...');
